...
__all__ = ("UnitCategoryModel", "UnitModel", "UnitCollectionModel", "PotentialValueModel", "ValueModel", "pretty_print")
...
class UnitModel:
    ...
    def __repr__(self):
        ...
        return f"<Unit name={self.name} " f'aliases={f", ".join(a for a in self.names[1:])}'
    ...
    @classmethod
    def new_si(cls, name: str, *other_names: str, never_use_std_form=False) -> "UnitModel":
        ...
        return cls(pass_through, pass_through, name, *other_names, is_si=True, never_use_std_form=never_use_std_form)


class UnitCollectionModel:
    def __init__(self, category: UnitCategoryModel, si: UnitModel, *other_conversions: UnitModel):
        self.si = si
    ...
    def find_unit(self, name: str) -> typing.Optional[UnitModel]:
        ...
        """
        return algorithms.find(lambda c: c == name, self.conversions)
...
def pretty_print(d: Decimal, suffix_name: str, use_long_suffix=False, use_std_form=True, none_if_rounds_to_zero=False):
    """
    ...
    if use_std_form:
        ...
        if rounded == Decimal(0) and none_if_rounds_to_zero:
            ...
            return f"{rounded_str} " f"{suffix[1 if use_long_suffix else 0]}{suffix_name}"
