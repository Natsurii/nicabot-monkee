...
SENTINELS = frozenset({_PAGE_BREAK, _LINE_BREAK, _DISABLE_TRUNCATION, _ENABLE_TRUNCATION, _MISSING_CP})
...
you do not do this, it will not be taken into account.
    ...
    def add_block(self, block, *, to_back: bool = True) -> "Paginator":
        """
        Adds a block of lines to the pagination, maintaining indentation.
