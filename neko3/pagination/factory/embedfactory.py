...
"""
__all__ = ("EmbedNavigatorFactory", "AbstractEmbedGenerator", "DefaultEmbedGenerator", "embed_generator")
...
from neko3.pagination.factory.basefactory import BaseFactory
from ..navigator import EmbedNavigator
...
def embed_generator(*, max_chars: int, provides_numbering=False):
    ...
    Example usage::
        ...
        >>> pagination = EmbedNavigatorFactory(factory=mk_red_page)
...
class EmbedNavigatorFactory(BaseFactory, Paginator):
    ...
    def build(
        ...
        **kwargs,
        ...
        n = EmbedNavigator(ctx, self._transform_pages(), buttons=buttons, timeout=timeout, initial_page=initial_page)
